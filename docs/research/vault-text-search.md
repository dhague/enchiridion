...
**This repo**: `CLAUDE.md`, `CONTEXT.md`, `docs/adr/0002`, `docs/adr/0004`, `docs/adr/0005`, `wiki-plugin/scripts/wikipage.py`, `wiki-plugin/scripts/build_index.py`, `wiki-plugin/scripts/commit.py`, `wiki-plugin/pyproject.toml`, `wiki-plugin/skills/wiki-ask/SKILL.md`, `wiki-plugin/agents/wiki-researcher.md`.
